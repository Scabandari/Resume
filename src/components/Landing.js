            ...
            <Grid container>
                ...
                <Grid item style={styles.text}>
                    ...
                    <br/> I'm an aspiring Software Engineer with interests in the areas of machine <br/> learning & A.I,
                        data science, blockchain and of course app development. <br/> <br/>
                        ...
                        school projects, pet projects and accomplishments then you can ...
                    </Typography>
                    <Typography variant="subtitle1" >
                        Continue as <Button component={Link} to="/home">Guest</Button>
                    </Typography>
                </Grid >
            </Grid>
        );
