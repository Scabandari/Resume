const gitDescriptions = {
    tldr: "I've been using git for a while now. I feel very comfortable with the basic workflow. I haven't " +
        ...
        "and voila.",
    longForm: "I've been for about 2 years now. We took a course where the main point of the " +
        ...
        "and push those changes to my github branch Ryan from where I do a pull request. Once in a while " +
        "I run into a situation where git won't let me do what I want to unless I make a commit, or stash " +
        "the changes but I haven't looked into that yet. You might see this when looking through any " +
        "old commits and see Nothing burger or something like that."
};
