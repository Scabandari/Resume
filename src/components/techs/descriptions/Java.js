...
const javaDescriptions = {
    ...
    longForm: "This is the second language that I learned after C++. It was a nice and seemed very intuitive " +
        ...
        "I was recently pair programming with a group member for our IOT Capstone project, making an " +
        "Android app. I'm more experienced in Python but if need be I can ramp up my Java knowledge quickly.",
    chips: tech_chips.java
};
